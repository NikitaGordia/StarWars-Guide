...
public class Starships extends InfoLoader {

    public static final String REF = "https://swapi.co/api/starships";
    public static final int ID = 4;

    public String name, model, manufacturer, costInCredits, length, maxAtmospheringSeed,
            crew, passengers, cargoCapacity, consumables, hyperdriveRating, MGLT, starshipClass,
            pilotsArr = "-", filmsArr = "-", created, edited, url;

    public Starships(Context context, TextView title, TextView info) {
    ...
    public void parse(JSONObject obj) throws JSONException {
        ...
        hyperdriveRating = obj.getString("hyperdrive_rating");
        MGLT = obj.getString("MGLT");
        starshipClass = obj.getString("starship_class");
